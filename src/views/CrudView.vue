  ...
  <div>
    ...
    <v-form>
      <v-container>
        <v-row>
          <v-col cols="12" md="6">
            <v-text-field required label="Name" v-model="dessert.name" />
          </v-col>
          <v-col cols="12" md="6">
            <v-text-field
              required
          ...
          <tr v-for="item in desserts" :key="item.id">
            ...
            <td class="text-center">
              <v-btn
                ...
                >Eliminar</v-btn
              >
              <v-btn color="warning" @click="activarUpdate(item)">Editar</v-btn>
            </td>
          </tr>
        </tbody>
      </template>
        ...
        <v-card-text>
          <v-form>
            <v-container>
              ...
              <v-btn block color="warning" @click="updateDessertForm"
                >Update</v-btn
              >
            </v-container>
          </v-form>
